...
/// \param viewController ViewController to present InBrain from. If no controller specified - InBrain will be presented from inBrainDelegate (if subclass of UIViewController) OR from UIApplication’s keyWindow
///
- (void)showNativeSurvey:(InBrainNativeSurvey * _Nonnull)survey offersEnabled:(BOOL)offersEnabled from:(UIViewController * _Nullable)viewController;
/// All the configs should be done <code>BEFORE</code> calling <code>showSurveys()</code>.
/// After survey completed - it becames invalid and cannot be opened again. Please, ensure all the NativeSurveys updated after <em>InBrainWebView</em> closed. Additional details may be found at <em>getNativeSurveys</em> function description
...
/// \param viewController ViewController to present InBrain from. If no controller specified - InBrain will be presented from inBrainDelegate (if subclass of UIViewController) OR from UIApplication’s keyWindow
///
- (void)showNativeSurveyWithId:(NSString * _Nonnull)surveyId searchId:(NSString * _Nonnull)searchId offersEnabled:(BOOL)offersEnabled from:(UIViewController * _Nullable)viewController;
- (void)showSurveysFrom:(UIViewController * _Nullable)viewController SWIFT_DEPRECATED_MSG("Please, use openWall(with:)");
- (void)showNativeSurvey:(InBrainNativeSurvey * _Nonnull)survey from:(UIViewController * _Nullable)viewController SWIFT_DEPRECATED_MSG("Please, use showNativeSurvey(survey:offersEnabled:from:)");
- (void)showNativeSurveyWithId:(NSString * _Nonnull)surveyId searchId:(NSString * _Nonnull)searchId from:(UIViewController * _Nullable)viewController SWIFT_DEPRECATED_MSG("Please, use showNativeSurveyWith(id:searchId:offersEnabled:from:)");
